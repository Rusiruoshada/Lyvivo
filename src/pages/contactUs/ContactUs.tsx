      ...
      <div className='mx-10 my-4'>
        ...
        <div className='grid grid-cols-7 text-white grid-rows-1 gap-1'>
          ...
          <div className='bg-green-600  flex justify-center items-center flex-col gap-3 p-3 col-span-2'>
            ...
            <p className='text-wrap'>lyvivocustomercare.jms@lyvivo.com</p>
          </div>
          <div className='bg-green-600  flex justify-center items-center flex-col gap-3 p-3 rounded-tr-[50px]'>
            <div className='rounded-full bg-white text-2xl w-fit shadow-md p-2 '>
              <FaFax className='text-green-600' />
            </div>
            <p className='text-wrap'>+94 11 230 3500</p>
          </div>
        </div>
      </div>
