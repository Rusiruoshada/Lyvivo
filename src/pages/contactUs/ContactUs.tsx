  ...
  return (
    <div>
      ...
      <div className='mx-10 my-4'>
        ...
        <div className='md:grid lg:grid flex flex-col grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-7  text-white gird-rows-4 sm:grid-rows-4 md:grid-rows-2 lg:grid-rows-1 gap-1 [&_p]:m-0 '>
